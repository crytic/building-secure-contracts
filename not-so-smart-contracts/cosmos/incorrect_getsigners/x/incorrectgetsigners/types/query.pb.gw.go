...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"trailofbits", "incorrect_getsigners", "incorrectgetsigners", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Posts_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"trailofbits", "incorrect_getsigners", "incorrectgetsigners", "posts"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Delegations_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"trailofbits", "incorrect_getsigners", "incorrectgetsigners", "delegations"}, "", runtime.AssumeColonVerbOpt(true)))
)
