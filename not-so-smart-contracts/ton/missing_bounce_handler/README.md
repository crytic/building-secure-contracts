...
- Implement a bounce handler in `recv_internal` that parses the bounced message opcode and reverts the corresponding state changes (e.g., re-credits the user's balance).
