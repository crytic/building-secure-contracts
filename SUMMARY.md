...
- [Not so smart contracts](./not-so-smart-contracts/README.md)
  ...
  - [Domain-Specific Vulnerabilities](./not-so-smart-contracts/domain-specific-vulnerabilities/README.md)
    - [DeFi Bridge](./not-so-smart-contracts/domain-specific-vulnerabilities/defi-bridge/README.md)
      - [Arbitrary External Calls](./not-so-smart-contracts/domain-specific-vulnerabilities/defi-bridge/arbitrary_external_calls/README.md)
      - [Cross-Chain Message Authentication Bypass](./not-so-smart-contracts/domain-specific-vulnerabilities/defi-bridge/cross_chain_message_authentication/README.md)
      - [Native Token Handling Inconsistency](./not-so-smart-contracts/domain-specific-vulnerabilities/defi-bridge/native_token_handling/README.md)
      - [Missing Recovery Mechanisms](./not-so-smart-contracts/domain-specific-vulnerabilities/defi-bridge/missing_recovery_mechanisms/README.md)
      - [Unchecked Return Values](./not-so-smart-contracts/domain-specific-vulnerabilities/defi-bridge/unchecked_return_values/README.md)
      - [ERC-777 Reentrancy](./not-so-smart-contracts/domain-specific-vulnerabilities/defi-bridge/erc777_reentrancy/README.md)
      - [Cross-Chain Address Assumptions](./not-so-smart-contracts/domain-specific-vulnerabilities/defi-bridge/cross_chain_address_assumptions/README.md)
      - [Gas Griefing](./not-so-smart-contracts/domain-specific-vulnerabilities/defi-bridge/gas_griefing/README.md)
    - [ERC-4337](./not-so-smart-contracts/domain-specific-vulnerabilities/erc4337/README.md)
      - [Missing EntryPoint in Operation Hash](./not-so-smart-contracts/domain-specific-vulnerabilities/erc4337/missing_entrypoint_in_hash/README.md)
      - [Cross-Chain Operation Replay](./not-so-smart-contracts/domain-specific-vulnerabilities/erc4337/cross_chain_operation_replay/README.md)
      - [Paymaster Deposit Drain via Signature Replay](./not-so-smart-contracts/domain-specific-vulnerabilities/erc4337/paymaster_deposit_drain/README.md)
      - [Bundler Gas Manipulation](./not-so-smart-contracts/domain-specific-vulnerabilities/erc4337/bundler_gas_manipulation/README.md)
      - [Unvalidated Gas Parameters in Paymaster](./not-so-smart-contracts/domain-specific-vulnerabilities/erc4337/unvalidated_gas_parameters/README.md)
      - [Account Creation Frontrunning](./not-so-smart-contracts/domain-specific-vulnerabilities/erc4337/account_creation_frontrunning/README.md)
      - [Incorrect Validation Return Values](./not-so-smart-contracts/domain-specific-vulnerabilities/erc4337/incorrect_validation_return_values/README.md)
      - [PostOp Revert Exploitation](./not-so-smart-contracts/domain-specific-vulnerabilities/erc4337/postop_revert_exploitation/README.md)
    - [Merkle Tree](./not-so-smart-contracts/domain-specific-vulnerabilities/merkle-tree/README.md)
      - [Empty Proof Bypass](./not-so-smart-contracts/domain-specific-vulnerabilities/merkle-tree/empty_proof_bypass/README.md)
      - [Leaf-Node Hash Collision](./not-so-smart-contracts/domain-specific-vulnerabilities/merkle-tree/leaf_node_collision/README.md)
      - [Missing Claim Replay Protection](./not-so-smart-contracts/domain-specific-vulnerabilities/merkle-tree/missing_claim_replay_protection/README.md)
      - [Arbitrary Proof Length](./not-so-smart-contracts/domain-specific-vulnerabilities/merkle-tree/arbitrary_proof_length/README.md)
      - [Missing Root Validation](./not-so-smart-contracts/domain-specific-vulnerabilities/merkle-tree/missing_root_validation/README.md)
      - [Missing Leaf Context](./not-so-smart-contracts/domain-specific-vulnerabilities/merkle-tree/missing_leaf_context/README.md)
      - [Inverted Verification Logic](./not-so-smart-contracts/domain-specific-vulnerabilities/merkle-tree/inverted_verification_logic/README.md)
      - [Unauthorized Root Update](./not-so-smart-contracts/domain-specific-vulnerabilities/merkle-tree/unauthorized_root_update/README.md)
    - [Precision Loss](./not-so-smart-contracts/domain-specific-vulnerabilities/precision-loss/README.md)
      - [Division Before Multiplication](./not-so-smart-contracts/domain-specific-vulnerabilities/precision-loss/division_before_multiplication/README.md)
      - [Incorrect Rounding Direction](./not-so-smart-contracts/domain-specific-vulnerabilities/precision-loss/incorrect_rounding_direction/README.md)
      - [Ratio Truncation to Zero](./not-so-smart-contracts/domain-specific-vulnerabilities/precision-loss/ratio_truncation_to_zero/README.md)
      - [Conflicting Rounding Requirements](./not-so-smart-contracts/domain-specific-vulnerabilities/precision-loss/conflicting_rounding_requirements/README.md)
      - [Rounding-Induced Denial of Service](./not-so-smart-contracts/domain-specific-vulnerabilities/precision-loss/rounding_induced_dos/README.md)
      - [Decimal Mismatch](./not-so-smart-contracts/domain-specific-vulnerabilities/precision-loss/decimal_mismatch/README.md)
      - [Fee Truncation Bypass](./not-so-smart-contracts/domain-specific-vulnerabilities/precision-loss/fee_truncation_bypass/README.md)
    - [Slippage](./not-so-smart-contracts/domain-specific-vulnerabilities/slippage/README.md)
      - [Missing Slippage Protection](./not-so-smart-contracts/domain-specific-vulnerabilities/slippage/missing_slippage_protection/README.md)
      - [On-Chain Slippage Calculation](./not-so-smart-contracts/domain-specific-vulnerabilities/slippage/onchain_slippage_calculation/README.md)
      - [Hardcoded Slippage Values](./not-so-smart-contracts/domain-specific-vulnerabilities/slippage/hardcoded_slippage_values/README.md)
      - [Missing Expiration Deadline](./not-so-smart-contracts/domain-specific-vulnerabilities/slippage/missing_expiration_deadline/README.md)
      - [Unapplied Slippage Parameters](./not-so-smart-contracts/domain-specific-vulnerabilities/slippage/unapplied_slippage_parameters/README.md)
      - [Shared Slippage Across Operations](./not-so-smart-contracts/domain-specific-vulnerabilities/slippage/shared_slippage_across_operations/README.md)
      - [Slippage Check at Wrong Stage](./not-so-smart-contracts/domain-specific-vulnerabilities/slippage/wrong_stage_slippage_check/README.md)
      - [Unprotected Share Minting](./not-so-smart-contracts/domain-specific-vulnerabilities/slippage/unprotected_minting/README.md)
    - [Tick Math](./not-so-smart-contracts/domain-specific-vulnerabilities/tick-math/README.md)
      - [slot0 Tick Misalignment](./not-so-smart-contracts/domain-specific-vulnerabilities/tick-math/slot0_tick_misalignment/README.md)
      - [Negative Tick Rounding](./not-so-smart-contracts/domain-specific-vulnerabilities/tick-math/negative_tick_rounding/README.md)
      - [Fee Growth Underflow](./not-so-smart-contracts/domain-specific-vulnerabilities/tick-math/fee_growth_underflow/README.md)
      - [Unsafe Integer Downcast](./not-so-smart-contracts/domain-specific-vulnerabilities/tick-math/unsafe_integer_downcast/README.md)
      - [Missing Tick Spacing Validation](./not-so-smart-contracts/domain-specific-vulnerabilities/tick-math/tick_spacing_validation/README.md)
      - [Tick Boundary Crossing](./not-so-smart-contracts/domain-specific-vulnerabilities/tick-math/tick_boundary_crossing/README.md)
      - [TWAP Array Inversion](./not-so-smart-contracts/domain-specific-vulnerabilities/tick-math/twap_array_inversion/README.md)
    - [Uniswap V4 Hooks](./not-so-smart-contracts/domain-specific-vulnerabilities/uniswap-v4-hooks/README.md)
      - [Hook Permission Flag Misconfiguration](./not-so-smart-contracts/domain-specific-vulnerabilities/uniswap-v4-hooks/permission_flag_misconfiguration/README.md)
      - [Direct PoolManager Bypass](./not-so-smart-contracts/domain-specific-vulnerabilities/uniswap-v4-hooks/direct_pool_manager_bypass/README.md)
      - [Hook Reentrancy](./not-so-smart-contracts/domain-specific-vulnerabilities/uniswap-v4-hooks/hook_reentrancy/README.md)
      - [Hook State Overwriting](./not-so-smart-contracts/domain-specific-vulnerabilities/uniswap-v4-hooks/hook_state_overwriting/README.md)
      - [Spot Price Manipulation in Hooks](./not-so-smart-contracts/domain-specific-vulnerabilities/uniswap-v4-hooks/spot_price_manipulation/README.md)
      - [Delta Sign Convention Errors](./not-so-smart-contracts/domain-specific-vulnerabilities/uniswap-v4-hooks/delta_sign_convention_errors/README.md)
      - [JIT Liquidity Fee Extraction](./not-so-smart-contracts/domain-specific-vulnerabilities/uniswap-v4-hooks/jit_liquidity_fee_extraction/README.md)
      - [Dynamic Fee Misconfiguration](./not-so-smart-contracts/domain-specific-vulnerabilities/uniswap-v4-hooks/dynamic_fee_misconfiguration/README.md)
    - [Voting Governance](./not-so-smart-contracts/domain-specific-vulnerabilities/voting-governance/README.md)
      - [Flash Loan Voting](./not-so-smart-contracts/domain-specific-vulnerabilities/voting-governance/flash_loan_voting/README.md)
      - [Double Voting](./not-so-smart-contracts/domain-specific-vulnerabilities/voting-governance/double_voting/README.md)
      - [Execution Without Quorum](./not-so-smart-contracts/domain-specific-vulnerabilities/voting-governance/execution_without_quorum/README.md)
      - [Timelock Bypass](./not-so-smart-contracts/domain-specific-vulnerabilities/voting-governance/timelock_bypass/README.md)
      - [Snapshot Timing Manipulation](./not-so-smart-contracts/domain-specific-vulnerabilities/voting-governance/snapshot_timing_manipulation/README.md)
      - [Delegation Power Manipulation](./not-so-smart-contracts/domain-specific-vulnerabilities/voting-governance/delegation_power_manipulation/README.md)
      - [Retroactive Parameter Changes](./not-so-smart-contracts/domain-specific-vulnerabilities/voting-governance/retroactive_parameter_changes/README.md)
      - [Vote After Transfer](./not-so-smart-contracts/domain-specific-vulnerabilities/voting-governance/vote_after_transfer/README.md)
