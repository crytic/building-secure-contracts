...
- [Not so smart contracts](./not-so-smart-contracts/README.md)
  ...
  - [Sui](./not-so-smart-contracts/sui/README.md)
    - [Mutable Reference Shadowing](./not-so-smart-contracts/sui/mutable_reference_shadowing/README.md)
    - [Arithmetic Overflow Abort](./not-so-smart-contracts/sui/arithmetic_overflow_abort/README.md)
    - [Unvalidated Shared Object Identity](./not-so-smart-contracts/sui/unvalidated_object_identity/README.md)
    - [Verifier Bypass via Package Upgrade](./not-so-smart-contracts/sui/verifier_bypass_via_upgrade/README.md)
    - [Runtime Limit Denial of Service](./not-so-smart-contracts/sui/runtime_limit_dos/README.md)
    - [Framework Hash Domain Separation](./not-so-smart-contracts/sui/framework_hash_domain_separation/README.md)
    - [Missing Object Uniqueness](./not-so-smart-contracts/sui/missing_object_uniqueness/README.md)
    - [Type Parameter Griefing](./not-so-smart-contracts/sui/type_parameter_griefing/README.md)
