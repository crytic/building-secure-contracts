...
- [Not so smart contracts](./not-so-smart-contracts/README.md)
  ...
  - [EVM Domains](./not-so-smart-contracts/evm-domains/README.md)
    - [DeFi Bridge](./not-so-smart-contracts/evm-domains/defi-bridge/README.md)
      - [Arbitrary External Calls](./not-so-smart-contracts/evm-domains/defi-bridge/arbitrary_external_calls/README.md)
      - [Cross-Chain Message Authentication Bypass](./not-so-smart-contracts/evm-domains/defi-bridge/cross_chain_message_authentication/README.md)
      - [Native Token Handling Inconsistency](./not-so-smart-contracts/evm-domains/defi-bridge/native_token_handling/README.md)
      - [Missing Recovery Mechanisms](./not-so-smart-contracts/evm-domains/defi-bridge/missing_recovery_mechanisms/README.md)
      - [Unchecked Return Values](./not-so-smart-contracts/evm-domains/defi-bridge/unchecked_return_values/README.md)
      - [ERC-777 Reentrancy](./not-so-smart-contracts/evm-domains/defi-bridge/erc777_reentrancy/README.md)
      - [Cross-Chain Address Assumptions](./not-so-smart-contracts/evm-domains/defi-bridge/cross_chain_address_assumptions/README.md)
      - [Gas Griefing](./not-so-smart-contracts/evm-domains/defi-bridge/gas_griefing/README.md)
    - [Merkle Tree](./not-so-smart-contracts/evm-domains/merkle-tree/README.md)
      - [Empty Proof Bypass](./not-so-smart-contracts/evm-domains/merkle-tree/empty_proof_bypass/README.md)
      - [Leaf-Node Hash Collision](./not-so-smart-contracts/evm-domains/merkle-tree/leaf_node_collision/README.md)
      - [Missing Claim Replay Protection](./not-so-smart-contracts/evm-domains/merkle-tree/missing_claim_replay_protection/README.md)
      - [Arbitrary Proof Length](./not-so-smart-contracts/evm-domains/merkle-tree/arbitrary_proof_length/README.md)
      - [Missing Root Validation](./not-so-smart-contracts/evm-domains/merkle-tree/missing_root_validation/README.md)
      - [Missing Leaf Context](./not-so-smart-contracts/evm-domains/merkle-tree/missing_leaf_context/README.md)
      - [Inverted Verification Logic](./not-so-smart-contracts/evm-domains/merkle-tree/inverted_verification_logic/README.md)
      - [Unauthorized Root Update](./not-so-smart-contracts/evm-domains/merkle-tree/unauthorized_root_update/README.md)
    - [Tick Math](./not-so-smart-contracts/evm-domains/tick-math/README.md)
      - [slot0 Tick Misalignment](./not-so-smart-contracts/evm-domains/tick-math/slot0_tick_misalignment/README.md)
      - [Negative Tick Rounding](./not-so-smart-contracts/evm-domains/tick-math/negative_tick_rounding/README.md)
      - [Fee Growth Underflow](./not-so-smart-contracts/evm-domains/tick-math/fee_growth_underflow/README.md)
      - [Unsafe Integer Downcast](./not-so-smart-contracts/evm-domains/tick-math/unsafe_integer_downcast/README.md)
      - [Missing Tick Spacing Validation](./not-so-smart-contracts/evm-domains/tick-math/tick_spacing_validation/README.md)
      - [Tick Boundary Crossing](./not-so-smart-contracts/evm-domains/tick-math/tick_boundary_crossing/README.md)
      - [TWAP Array Inversion](./not-so-smart-contracts/evm-domains/tick-math/twap_array_inversion/README.md)
    - [Voting Governance](./not-so-smart-contracts/evm-domains/voting-governance/README.md)
      - [Flash Loan Voting](./not-so-smart-contracts/evm-domains/voting-governance/flash_loan_voting/README.md)
      - [Double Voting](./not-so-smart-contracts/evm-domains/voting-governance/double_voting/README.md)
      - [Execution Without Quorum](./not-so-smart-contracts/evm-domains/voting-governance/execution_without_quorum/README.md)
      - [Timelock Bypass](./not-so-smart-contracts/evm-domains/voting-governance/timelock_bypass/README.md)
      - [Snapshot Timing Manipulation](./not-so-smart-contracts/evm-domains/voting-governance/snapshot_timing_manipulation/README.md)
      - [Delegation Power Manipulation](./not-so-smart-contracts/evm-domains/voting-governance/delegation_power_manipulation/README.md)
      - [Retroactive Parameter Changes](./not-so-smart-contracts/evm-domains/voting-governance/retroactive_parameter_changes/README.md)
      - [Vote After Transfer](./not-so-smart-contracts/evm-domains/voting-governance/vote_after_transfer/README.md)
