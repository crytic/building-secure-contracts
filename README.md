...
- [Not So Smart Contracts](./not-so-smart-contracts): Examples of common smart contract issues, complete with descriptions, examples, and recommendations
  ...
  - [Domain-Specific Vulnerabilities](./not-so-smart-contracts/domain-specific-vulnerabilities): Vulnerability patterns tied to specific application domains
    - [DeFi Bridge](./not-so-smart-contracts/domain-specific-vulnerabilities/defi-bridge)
    - [ERC-4337](./not-so-smart-contracts/domain-specific-vulnerabilities/erc4337)
    - [Merkle Tree](./not-so-smart-contracts/domain-specific-vulnerabilities/merkle-tree)
    - [Precision Loss](./not-so-smart-contracts/domain-specific-vulnerabilities/precision-loss)
    - [Slippage](./not-so-smart-contracts/domain-specific-vulnerabilities/slippage)
    - [Tick Math](./not-so-smart-contracts/domain-specific-vulnerabilities/tick-math)
    - [Uniswap V4 Hooks](./not-so-smart-contracts/domain-specific-vulnerabilities/uniswap-v4-hooks)
    - [Voting Governance](./not-so-smart-contracts/domain-specific-vulnerabilities/voting-governance)
