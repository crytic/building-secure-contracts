...
- [Not So Smart Contracts](./not-so-smart-contracts): Examples of common smart contract issues, complete with descriptions, examples, and recommendations
  ...
  - [Domain-Specific Vulnerabilities](./not-so-smart-contracts/domain_specific_vulnerabilities): Vulnerability patterns tied to specific application domains
    - [DeFi Bridge](./not-so-smart-contracts/domain_specific_vulnerabilities/defi_bridge)
    - [ERC-4337](./not-so-smart-contracts/domain_specific_vulnerabilities/erc4337)
    - [Merkle Tree](./not-so-smart-contracts/domain_specific_vulnerabilities/merkle_tree)
    - [Precision Loss](./not-so-smart-contracts/domain_specific_vulnerabilities/precision_loss)
    - [Slippage](./not-so-smart-contracts/domain_specific_vulnerabilities/slippage)
    - [Tick Math](./not-so-smart-contracts/domain_specific_vulnerabilities/tick_math)
    - [Uniswap V4 Hooks](./not-so-smart-contracts/domain_specific_vulnerabilities/uniswap_v4_hooks)
    - [Voting Governance](./not-so-smart-contracts/domain_specific_vulnerabilities/voting_governance)
