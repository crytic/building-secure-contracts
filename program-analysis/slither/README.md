...
- [Detector Notebook](./jupyter/Detectors.ipynb)
...
- [Printer Notebook](./jupyter/Printers.ipynb)
...
- [API Notebook](./jupyter/API.ipynb)
...
You can run the Jupyter Notebook server from this directory or navigate into the
`/jupyter` directory and run the start command from there.
...
Navigate to the url printed in the console to access the UI.
