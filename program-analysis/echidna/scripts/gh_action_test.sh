...
install_echidna(){
    ...
    wget https://github.com/crytic/echidna/releases/download/1.2.0.0/echidna-test-v1.2.0.0-Ubuntu-18.04.tar.gz
    tar -xvf echidna-test-v1.2.0.0-Ubuntu-18.04.tar.gz
