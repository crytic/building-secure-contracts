...
contract PopsicleFixed is ERC20 {
    ...
    function OwnerDoItsJobAndEarnsFeesToLPs() public payable {
        totalFeesEarned += 1;
    }
    ...
    // Get the total balance of a user which is equal to its ETH balance plus its balance of PopsicleFixed tokens.
